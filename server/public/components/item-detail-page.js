...
class ItemDetailPage extends LitElement {
  static properties = {
    ...
    showPaymentConfirm: { type: Boolean } // New state for modal
  };
...
//           ${isSeller
//             ? html`
//               <p class="mt-6 rounded-lg bg-slate-50 px-3 py-2 text-sm text-slate-600">
//                 This is your listing. Buyer conversations are shown below.
//               </p>
//             `
//             : ''}
//         </div>
...
//           <section class="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
//             <h2 class="text-lg font-semibold text-slate-900">Buyer Conversations</h2>
//             <p class="mt-1 text-sm text-slate-600">See who contacted you about this product.</p>
...
//               <p class="mt-1 text-sm text-slate-600">
//                 Amount due:
//                 <span class="font-semibold text-slate-900">${this._formatPrice(payableAmount)}</span>
//                 ${this.item.acceptedOffer && this.item.acceptedBuyerId === this.currentUser.id
//                   ? html`<span class="ml-1 text-xs text-green-700">(accepted negotiated amount)</span>`
//                   : html`<span class="ml-1 text-xs text-slate-500">(listing amount)</span>`}
//               </p>
//               <p class="mt-1 text-xs text-slate-500">
//                 If the seller accepts a new negotiated price, this payment amount updates automatically.
//               </p>

//               ${alreadyPaidByCurrentBuyer
//                 ? html`
//                     <p class="mt-3 rounded-lg bg-green-50 px-3 py-2 text-sm text-green-700">
//                       Payment already marked as paid for your account.
//                     </p>
//                   `
//                 : html`
//                     <div class="mt-4 flex flex-col gap-3 sm:flex-row sm:items-end">
...
//                           class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
//                         />
//                       </div>
//                       <button
//                         @click=${this._submitPayment}
//                         ?disabled=${this.paymentSubmitting}
//                         class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 disabled:opacity-60"
//                       >
//                         ${this.paymentSubmitting ? 'Processing...' : 'Make Payment'}
...
//                     </div>
//                     ${this.paymentError
//                       ? html`<p class="mt-2 text-sm text-red-600">${this.paymentError}</p>`
//                       : ''}
//                   `}
//             </section>
//           `
...
//                     : 'Chat will appear here when the seller conversation is ready.'}
//                 </p>
//               </section>
//             `
//         : html`
//             <section class="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
//               <p class="text-sm text-slate-500">Login to chat with the seller from this page.</p>
//               <a href="/login" class="mt-3 inline-flex rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-700 transition">
//                 Go to Login
//               </a>
//             </section>
//           `}
